...
public class Copy_12_of_RTSoundEvent extends SoundEvent {
  ...
  //  volatile boolean audioread;
	...
	public Copy_12_of_RTSoundEvent(){
...
System.out.println("音频开始播放了 当前时间是："+this.time);		
	...
	public class RTAudioStream extends AudioStream{
		...
		public byte[] sampledatapool=new byte[35280*2];
...
//	System.out.println("audiostream是否是打开的"+this.isOpen());		
	...
	System.out.println("在readsample方法中的音频回收工具为null");				
					try {
			...
			double startctime= Copy_12_of_RTSoundEvent.this.time;
			...
			do{
				  ...
				  AudioDataBox databox=null;
					    ...
					    currentctime= Copy_12_of_RTSoundEvent.this.time;
				...
				*/
					    ...
					    double  newctime=Copy_12_of_RTSoundEvent.this.time;
	...
	System.out.println("！！！！！！！我返回了");					
				...
				//	this.samplesperframe=audatabox.connectorsrcsamplesperframe;
				 ...
				 if(firstcome){
					...
					// audiopts=((databox.connectorpts_blurwritensample)*1.0/databox.connectorsrcsamplerate)-(2.0*hw_buffer_size); 	
		        		if(audiodebug)
