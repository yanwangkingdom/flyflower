...
public class TestAudio {
	...
	static String filter_descr = "aresample=8000,aformat=sample_fmts=s16:channel_layouts=mono";
	static String player       = "ffplay -f s16le -ar 8000 -ac 1 -";
	...
	static int init_filters(const char *filters_descr)
	{
	    ...
	    printf("1filtergraph中的filter个数%d\n",filter_graph->nb_filters);
	    ...
	    printf("2filtergraph中的filter个数%d\n",filter_graph->nb_filters);
	    ...
	    if ((ret = avfilter_graph_parse_ptr(filter_graph, filters_descr,
	        ...
	        goto end;
	    printf("解析ptr之后filter个数%d",filter_graph->nb_filters);
