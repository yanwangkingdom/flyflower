 ...
 *
 */
public class successTestPicturePlay {
	  ...
	  while (true)
	   {
	    	...
	    	if (packet.stream_index == videoStream){
	    		...
	    		System.out.println("我已经要找到视频了"+"   "+packet.pts+"   "+i++);
	    		...
	    		/*for(int l=0;l<linesizes.length;l++){
	    			System.out.println(linesizes[l]);
	    		}
	    		
	    		
	    		for(int l=0;l<nativelinesizes.length;l++){
	    			System.out.println("native data   "+nativelinesizes[l]);
	    		}*/
