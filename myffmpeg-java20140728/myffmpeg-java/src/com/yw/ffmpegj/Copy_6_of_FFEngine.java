...
/**
 * 我将要把音频格式的转换转移到readSample方法中 他是一个没有实现音频伸缩的算法的这种引擎 所以做了次备份
 * @author wang
 *
 */
public class Copy_6_of_FFEngine implements FFController{
...
//System.out.println(audiocodec.toString());
	...
	public Copy_6_of_FFEngine(String filename,Collection<? extends VideoConnector> connectors) {
	...
	public Copy_6_of_FFEngine(String filename,Collection<? extends VideoConnector> videoconnectors,Collection<? extends AudioConnector> audioconnectors) {
...
// System.out.println("audioframe to string"+audioframe.toString());
	...
	//	System.out.println("音频帧的数量"+testframeconunt);					 
		...
		//System.out.println("格式占用的字节是"+srcpersamplesize);
				 	    		...
				 	    		swrcontext=SWRESAMPLE.swr_alloc_set_opts(null, (long)AVUtilLibrary.AV_CH_LAYOUT_STEREO, AVUtilLibrary.AVSampleFormat.AV_SAMPLE_FMT_S16, 44100,dec_channel_layout ,srcformat, srcsamplerate, 0, null);//设置swr上下文
	...
	public Copy_6_of_FFEngine(String filename) {
		super();
		this.filename = filename;
	}
