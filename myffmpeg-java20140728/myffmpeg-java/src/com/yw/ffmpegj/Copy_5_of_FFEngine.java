...
public class Copy_5_of_FFEngine implements FFController{
...
//System.out.println(audiocodec.toString());
	...
	public Copy_5_of_FFEngine(String filename,Collection<? extends VideoConnector> connectors) {
	...
	public Copy_5_of_FFEngine(String filename,Collection<? extends VideoConnector> videoconnectors,Collection<? extends AudioConnector> audioconnectors) {
...
// System.out.println("audioframe to string"+audioframe.toString());
	...
	public Copy_5_of_FFEngine(String filename) {
		super();
		this.filename = filename;
	}
