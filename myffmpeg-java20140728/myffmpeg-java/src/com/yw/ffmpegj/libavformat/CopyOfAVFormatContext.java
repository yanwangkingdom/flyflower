...
public class CopyOfAVFormatContext extends Structure
{
    public static class ByReference extends CopyOfAVFormatContext
    ...
    public static class ByValue extends CopyOfAVFormatContext
