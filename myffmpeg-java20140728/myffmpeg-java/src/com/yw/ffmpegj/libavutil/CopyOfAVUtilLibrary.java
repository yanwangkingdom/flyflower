...
public interface CopyOfAVUtilLibrary
    extends Library
{
   ...
   /* public static class AVRational extends PointerType
    ...
    public static final CopyOfAVUtilLibrary INSTANCE = (CopyOfAVUtilLibrary)Native.loadLibrary(JNA_LIBRARY_NAME, CopyOfAVUtilLibrary.class);
...
//end rational.h
	...
	public abstract  void av_opt_set_int_list(Pointer filtercontext,Pointer name,Pointer val,Pointer term,Pointer flag);
