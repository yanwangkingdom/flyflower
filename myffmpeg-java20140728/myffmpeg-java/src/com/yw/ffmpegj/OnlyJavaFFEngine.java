...
public class OnlyJavaFFEngine implements FFController{
...
//System.out.println(audiocodec.toString());
	...
	public OnlyJavaFFEngine(String filename,Collection<? extends VideoConnector> connectors) {
	...
	public OnlyJavaFFEngine(String filename,Collection<? extends VideoConnector> videoconnectors,Collection<? extends AudioConnector> audioconnectors) {
	...
	public OnlyJavaFFEngine() {
		super();
		// TODO Auto-generated constructor stub
		 initVariable();
	}
	
	public OnlyJavaFFEngine(String filename) {
		super();
		this.filename = filename;
		initVariable();
	}
	...
	public class VideoThread implements Runnable{
		...
		public void run() {
			// TODO Auto-generated method stub
			 open_video(videocodecCtx.width, videocodecCtx.height);
        	    		...
        	    		/* VideoConnector connector=freevpq.poll();
     	    			 if(connector==null){
        		    		...
        		    		//ByteBuffer convertdata=	distframe.data[0].getByteBuffer(0, videocodecCtx.height * distframe.linesize[0]);
        	    		       ...
        	    		       // final byte[] data =convertdata.array();
        	    	    		
        	    		        final byte[] data = distframe.data[0].getByteArray(0, videocodecCtx.height * distframe.linesize[0]);
        	    		        
        	                    final BufferedImage bi = FrameDataToImage.createImage(data, videocodecCtx.width, videocodecCtx.height);
	 ...
	 //	System.out.println("解码出的音频的长度为："+codecaulength);
						...
						audiopacket.writeField("size");
			 	    	...
			 	    	if(ret<0){
			 	    	   ...
			 	    	   byte[] audiodata=out.getValue().getByteArray(0, targetbuffersize);
			 	    		
			 	    		audiomixer.playAudio(audiodata);
//System.out.println("我已经写入音频数据");
