...
/**
 * @author wang
 * 这个类及其以前的类不存在关于实时流媒体的特殊处理
 *
 */
public class Copy_9_of_FFEngine implements FFController{
...
//System.out.println(audiocodec.toString());
	...
	public Copy_9_of_FFEngine(String filename,Collection<? extends VideoConnector> connectors) {
	...
	public Copy_9_of_FFEngine(String filename,Collection<? extends VideoConnector> videoconnectors,Collection<? extends AudioConnector> audioconnectors) {
...
// System.out.println("audioframe to string"+audioframe.toString());
	...
	public Copy_9_of_FFEngine(String filename) {
		super();
		this.filename = filename;
	}
