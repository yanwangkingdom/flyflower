...
public class Copy_7_of_FFEngine implements FFController{
...
//System.out.println(audiocodec.toString());
	...
	public Copy_7_of_FFEngine(String filename,Collection<? extends VideoConnector> connectors) {
	...
	public Copy_7_of_FFEngine(String filename,Collection<? extends VideoConnector> videoconnectors,Collection<? extends AudioConnector> audioconnectors) {
...
// System.out.println("audioframe to string"+audioframe.toString());
	...
	//	System.out.println("音频帧的数量"+testframeconunt);					 
		...
		//System.out.println("格式占用的字节是"+srcpersamplesize);
			...
			//	System.out.println("swrcontext 初始化失败");
				 	    		...
				 	    		targetnbsamples=convertSrcnbSample2tnbs(audioframe.nb_samples,IWANTFREQ,srcsamplerate);
	...
	public Copy_7_of_FFEngine(String filename) {
		super();
		this.filename = filename;
	}
	...
	public class RecycleAU implements AudioToolAndReccyclebin{
		...
		@Override
		public void  getSyncedAudio(AudioConnector ac, double diff) {
			// TODO Auto-generated method stub
