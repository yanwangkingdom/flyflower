...
public class ISpeechAudio extends Dispatch {

	public static final String componentName = "SpeechLib.ISpeechAudio";
	...
	*/
	public ISpeechAudio(Dispatch d) {
	...
	public ISpeechAudio(String compName) {
		super(compName);
	}
