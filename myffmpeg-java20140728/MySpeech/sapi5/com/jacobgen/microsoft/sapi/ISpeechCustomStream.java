...
public class ISpeechCustomStream extends Dispatch {

	public static final String componentName = "SpeechLib.ISpeechCustomStream";

	public ISpeechCustomStream() {
		super(componentName);
	}
	...
	*/
	public ISpeechCustomStream(Dispatch d) {
	...
	public ISpeechCustomStream(String compName) {
		super(compName);
	}
	 ...
	 * @return the result is of type Variant
	 */
	public Variant getBaseStream() {
		return Dispatch.get(this, "BaseStream");
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param baseStream an input-parameter of type Variant
	 */
	public void setBaseStream(Variant baseStream) {
		Dispatch.put(this, "BaseStream", baseStream);
	}
