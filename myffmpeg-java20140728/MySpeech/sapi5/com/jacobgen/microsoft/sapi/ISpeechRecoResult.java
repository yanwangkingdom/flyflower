...
public class ISpeechRecoResult extends Dispatch {

	public static final String componentName = "SpeechLib.ISpeechRecoResult";

	public ISpeechRecoResult() {
		super(componentName);
	}
	...
	*/
	public ISpeechRecoResult(Dispatch d) {
	...
	public ISpeechRecoResult(String compName) {
		super(compName);
	}
