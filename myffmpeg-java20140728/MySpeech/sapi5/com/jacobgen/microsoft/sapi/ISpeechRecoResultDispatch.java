...
public class ISpeechRecoResultDispatch extends Dispatch {

	public static final String componentName = "SpeechLib.ISpeechRecoResultDispatch";

	public ISpeechRecoResultDispatch() {
		super(componentName);
	}
	...
	*/
	public ISpeechRecoResultDispatch(Dispatch d) {
	...
	public ISpeechRecoResultDispatch(String compName) {
		super(compName);
	}
	...
	public ISpeechPhraseAlternates alternates(int requestCount, int startElement, int elements) {
		ISpeechPhraseAlternates result_of_Alternates = new ISpeechPhraseAlternates(Dispatch.call(this, "Alternates", new Variant(requestCount), new Variant(startElement), new Variant(elements)).toDispatch());


		return result_of_Alternates;
	}
	...
	public ISpeechMemoryStream audio(int startElement, int elements) {
		ISpeechMemoryStream result_of_Audio = new ISpeechMemoryStream(Dispatch.call(this, "Audio", new Variant(startElement), new Variant(elements)).toDispatch());


		return result_of_Audio;
	}
