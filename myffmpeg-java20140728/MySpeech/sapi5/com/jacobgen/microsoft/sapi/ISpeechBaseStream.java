...
public class ISpeechBaseStream extends Dispatch {

	public static final String componentName = "SpeechLib.ISpeechBaseStream";

	public ISpeechBaseStream() {
		super(componentName);
	}
	...
	*/
	public ISpeechBaseStream(Dispatch d) {
	...
	public ISpeechBaseStream(String compName) {
		super(compName);
	}
