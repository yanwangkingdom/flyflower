...
public class FullSeriesCollection extends Dispatch {

	public static final String componentName = "Word.FullSeriesCollection";

	public FullSeriesCollection() {
		super(componentName);
	}
	...
	*/
	public FullSeriesCollection(Dispatch d) {
	...
	public FullSeriesCollection(String compName) {
		super(compName);
	}
