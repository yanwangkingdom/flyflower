...
public class ChartCategory extends Dispatch {

	public static final String componentName = "Word.ChartCategory";
	...
	*/
	public ChartCategory(Dispatch d) {
	...
	public ChartCategory(String compName) {
		super(compName);
	}
