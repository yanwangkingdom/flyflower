...
public class GlowFormat extends Dispatch {

	public static final String componentName = "Word.GlowFormat";
	...
	*/
	...
	public GlowFormat(String compName) {
		super(compName);
	}
	...
	public ColorFormat getColor() {
		return new ColorFormat(Dispatch.get(this, "Color").toDispatch());
	}
