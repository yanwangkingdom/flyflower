...
public class DataLabel extends Dispatch {

	public static final String componentName = "Word.DataLabel";
	...
	*/
	...
	public DataLabel(String compName) {
		super(compName);
	}
	...
	public double get_Height() {
		return Dispatch.get(this, "_Height").changeType(Variant.VariantDouble).getDouble();
	}
	...
	public double get_Width() {
		return Dispatch.get(this, "_Width").changeType(Variant.VariantDouble).getDouble();
	}
