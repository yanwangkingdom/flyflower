...
public class ChartArea extends Dispatch {

	public static final String componentName = "Word.ChartArea";
	...
	*/
	...
	public ChartArea(String compName) {
		super(compName);
	}
