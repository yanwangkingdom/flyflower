...
public class Page extends Dispatch {

	public static final String componentName = "Word.Page";
	...
	*/
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @return the result is of type Rectangles
	 */
	public Rectangles getRectangles() {
		return new Rectangles(Dispatch.get(this, "Rectangles").toDispatch());
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @return the result is of type Breaks
	 */
	public Breaks getBreaks() {
		return new Breaks(Dispatch.get(this, "Breaks").toDispatch());
	}
	...
	public void saveAsPNG(String fileName) {
		Dispatch.call(this, "SaveAsPNG", fileName);
	}
