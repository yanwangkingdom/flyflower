...
public class OMathMatCol extends Dispatch {

	public static final String componentName = "Word.OMathMatCol";
	...
	*/
	...
	public OMathMatCol(String compName) {
		super(compName);
	}
	...
	public int getColIndex() {
		return Dispatch.get(this, "ColIndex").changeType(Variant.VariantInt).getInt();
	}
