...
public class DefaultWebOptions extends Dispatch {
	...
	*/
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @return the result is of type WebPageFonts
	 */
	public WebPageFonts getFonts() {
		return new WebPageFonts(Dispatch.get(this, "Fonts").toDispatch());
	}
	 ...
	 * @return the result is of type boolean
	 */
	public boolean getSaveNewWebPagesAsWebArchives() {
		return Dispatch.get(this, "SaveNewWebPagesAsWebArchives").changeType(Variant.VariantBoolean).getBoolean();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param saveNewWebPagesAsWebArchives an input-parameter of type boolean
	 */
	public void setSaveNewWebPagesAsWebArchives(boolean saveNewWebPagesAsWebArchives) {
		Dispatch.put(this, "SaveNewWebPagesAsWebArchives", new Variant(saveNewWebPagesAsWebArchives));
	}
