...
public class DiagramNodes extends Dispatch {

	public static final String componentName = "Word.DiagramNodes";
	...
	*/
	public DiagramNodes(Dispatch d) {
	...
	public DiagramNodes(String compName) {
		super(compName);
	}
