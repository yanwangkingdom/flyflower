...
public class FootnoteOptions extends Dispatch {

	public static final String componentName = "Word.FootnoteOptions";
	...
	*/
	public FootnoteOptions(Dispatch d) {
	...
	public FootnoteOptions(String compName) {
		super(compName);
	}
	...
	public int getLayoutColumns() {
		return Dispatch.get(this, "LayoutColumns").changeType(Variant.VariantInt).getInt();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param layoutColumns an input-parameter of type int
	 */
	public void setLayoutColumns(int layoutColumns) {
		Dispatch.put(this, "LayoutColumns", new Variant(layoutColumns));
	}
