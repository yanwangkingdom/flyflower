...
public class Editor extends Dispatch {

	public static final String componentName = "Word.Editor";
	...
	*/
	...
	public Range getNextRange() {
		return new Range(Dispatch.get(this, "NextRange").toDispatch());
	}
