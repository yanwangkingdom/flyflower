...
public class DisplayUnitLabel extends Dispatch {

	public static final String componentName = "Word.DisplayUnitLabel";
	...
	*/
	public DisplayUnitLabel(Dispatch d) {
	...
	public DisplayUnitLabel(String compName) {
		super(compName);
	}
