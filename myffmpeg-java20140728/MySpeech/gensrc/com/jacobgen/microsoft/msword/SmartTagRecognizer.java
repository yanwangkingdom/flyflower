...
public class SmartTagRecognizer extends Dispatch {

	public static final String componentName = "Word.SmartTagRecognizer";
	...
	*/
	public SmartTagRecognizer(Dispatch d) {
	...
	public SmartTagRecognizer(String compName) {
		super(compName);
	}
