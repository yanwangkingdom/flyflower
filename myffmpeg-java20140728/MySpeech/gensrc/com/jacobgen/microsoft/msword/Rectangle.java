...
public class Rectangle extends Dispatch {

	public static final String componentName = "Word.Rectangle";
	...
	*/
	...
	public Rectangle(String compName) {
		super(compName);
	}
	...
	public int getRectangleType() {
		return Dispatch.get(this, "RectangleType").changeType(Variant.VariantInt).getInt();
	}
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @return the result is of type Lines
	 */
	public Lines getLines() {
		return new Lines(Dispatch.get(this, "Lines").toDispatch());
	}
