...
public class IApplicationEvents3 extends Dispatch {

	public static final String componentName = "Word.IApplicationEvents3";
	...
	*/
	public IApplicationEvents3(Dispatch d) {
	...
	public IApplicationEvents3(String compName) {
		super(compName);
	}
