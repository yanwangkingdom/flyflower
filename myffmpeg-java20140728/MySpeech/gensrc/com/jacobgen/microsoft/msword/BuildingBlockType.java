...
public class BuildingBlockType extends Dispatch {

	public static final String componentName = "Word.BuildingBlockType";
	...
	*/
	public BuildingBlockType(Dispatch d) {
	...
	public BuildingBlockType(String compName) {
		super(compName);
	}
