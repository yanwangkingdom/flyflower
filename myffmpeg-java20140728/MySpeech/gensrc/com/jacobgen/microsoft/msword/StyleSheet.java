...
public class StyleSheet extends Dispatch {

	public static final String componentName = "Word.StyleSheet";
	...
	*/
	...
	public StyleSheet(String compName) {
		super(compName);
	}
	 ...
	 */
	public void move(int precedence) {
		Dispatch.call(this, "Move", new Variant(precedence));
	}
