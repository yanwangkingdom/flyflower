...
public class ChartColorFormat extends Dispatch {

	public static final String componentName = "Word.ChartColorFormat";
	...
	*/
	public ChartColorFormat(Dispatch d) {
	...
	public ChartColorFormat(String compName) {
		super(compName);
	}
	...
	public int get_Default() {
		return Dispatch.get(this, "_Default").changeType(Variant.VariantInt).getInt();
	}
